    ...
    <div class="auth-content">
        ...
        <Card class="auth-card">
          <template #content>
            ...
            <div class="signin-link">
              ...
              <RouterLink :to="{ name: 'login' }" class="signin-link-text">Log In</RouterLink>
            </div>

            <div class="invite-link">
              <span class="invite-text">Have an invitation? </span>
              <RouterLink :to="{ name: 'invite-signup' }" class="invite-link-text">Join by Invite</RouterLink>
            </div>
      ...
      <Card v-else class="auth-card success-card">
        <template #content>
          ...
          <Message severity="info" class="success-message">
            ...
            <div>
              ...
              <ul class="message-list">
                ...
                <li>Once verified, you can log in to BeakerHub</li>
              </ul>
            </div>
          </Message>
          ...
          <Button @click="goToVerification" class="continue-button" size="large">
            Verify Email
          </Button>
        </template>
      </Card>
...
const goToVerification = () => {
  router.push({ name: 'email-validation', query: { email: formData.value.email } });
};
</script>
