        ...
        <Card class="auth-card">
          <template #content>
            ...
            <div class="signup-link">
              ...
              <RouterLink :to="{ name: 'signup' }" class="signup-link-text">Request Access</RouterLink>
            </div>
...
const handleSubmit = async () => {
  // TODO: This does not seem to do anything. Looks to be a path for verification that has not been defined.
